...
- Bump @babel/core from 7.26.10 to 7.28.3
...
- Bump eslint from 9.25.1 to 9.34.0
- Bump eslint-config-prettier from 10.1.2 to 10.1.8
- Bump io.github.bonigarcia:webdrivermanager from 6.1.0 to 6.3.1
...
- Bump org.jenkins-ci.plugins:plugin from 5.12 to 5.24
