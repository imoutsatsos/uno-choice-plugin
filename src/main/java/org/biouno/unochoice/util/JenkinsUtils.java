...
public final class JenkinsUtils
{
  ...
  {
    Object evaluate = execute(script, Collections.<String, Object> emptyMap());
    return evaluate;
  }
   ...
   * @return result from the script
   */
  public static Object execute(String script, Map<String, Object> parameters, FilePath[] classPaths)
  {
    try
    {
